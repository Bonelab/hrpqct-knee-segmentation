...
def create_parser():
    ...
    parser.add_argument(
        "--num-adjacent-slices", "-nas", type=int, default=2, metavar="N",
        help="Number of adjacent slices to use in stacks."
    )
    parser.add_argument(
...
def main():
    ...
    sampler = ComposedSampler([
        MultisliceSampler(num_adjacent_slices=args.num_adjacent_slices),
