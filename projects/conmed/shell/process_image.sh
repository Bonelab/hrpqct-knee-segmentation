...
sleep 0.1
JID_INF=$(sbatch --export=IMAGE=${IMAGE},BONE=${BONE},SIDE=${SIDE} --dependency=afterany:${JID_PRE} projects/conmed/slurm/1_inference_unetpp_and_segresnetvae.slurm | tr -dc "0-9")
